<main class="main-content px-4 py-8 md:flex-1 md:p-12 md:overflow-y-auto relative">
    <template x-if="$wire.feedback">
        <div
            ...
            class="dissolve absolute top-4 flex items-center justify-between mb-8 max-w-3xl bg-green-500 rounded">
        ...
        <div x-data="{organization_name: $wire.form.name}">
            <h1 class="mb-8 text-3xl font-bold">
                <a class="text-indigo-400 hover:text-indigo-600"
                   href="/organizations" wire:navigate>Organizations</a>
                <span class="text-indigo-400 font-medium">/</span>
                <span class="text-indigo-400">Create</span>
                <span class="text-indigo-400 font-medium">/</span>
                ...
                <form wire:submit="save">
                    ...
                    <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100"
                        ...
                        <button class="flex items-center btn-indigo ml-auto"
                                @click="click = true; setTimeout(() => click = false, 1000)" type="submit">
                            <svg x-show="click" class="mr-2 w-5 h-5 text-white animate-spin"
                                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke-width="3">
                                <circle class="opacity-25 text-white" cx="12" cy="12" r="10"
                                        stroke="currentColor"></circle>
                                <path class="opacity-75 text-white" fill="currentColor"
                                      d="M4 12a8 8 0 018-8v4l5-5-5-5v4a10 10 0 00-7.8 15.6l1.4-1.4A8 8 0 014 12z"></path>
                            </svg>
